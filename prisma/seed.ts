...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      screenshots: [
        "/products/company-profile/screenshot-hero.png",
        "/products/company-profile/screenshot-services.png",
        "/products/company-profile/screenshot-about.png",
        "/products/company-profile/screenshot-cta.png",
      ],
      order: 3,
    },
  ];
  ...
  const projects = [
    {
      ...
      coverImage: "/products/biku/logo.png",
      featured: true,
      order: 1,
    },
    {
      ...
      coverImage: "/products/digital-menu/cover-illustration.png",
      featured: true,
      order: 2,
    },
    {
      ...
      coverImage: "/products/company-profile-cover.png",
      featured: false,
      order: 3,
    },
  ];
